...
import { ProjectDetailModal } from '../project-details/project-details';

@Component({
  selector: 'app-projects',
  templateUrl: './projects.html',
  styleUrls: ['./projects.scss'],
  imports: [CommonModule, ProjectDetailModal],
})
  ...
  projects = [
    {
      ...
      images: [
        '/images/loadrite1.png',
        '/images/loadrite2.jpg',
        '/images/loadrite3.jpg',
      ],
      tasks: [
    ...
    },
    {
      ...
      images: [
        '/images/uoamedia1.png',
        '/images/uoamedia2.png',
        '/images/uoamedia3.png',
        '/images/uoamedia4.png',
      ],
      tasks: [
    ...
    },
    {
      ...
      images: [
        '/images/demoblaze1.png',
        '/images/demoblaze2.png',
        '/images/demoblaze3.png',
      ],
      tasks: [
